...
def final_evaluation(reshaped_dataset, bovw_dataset, lbp_dataset, labels, training_set_dir, SSL_models, kmeans, output_dir):
    ...
    for class_label, models in trained_models.items():
        ...
        for r in range(1, len(model_names) + 1):
            for model_subset in combinations(model_names, r):
                ...
                for threshold in np.arange(0.05, 0.7, 0.025):
                    ...
                    f1_vote = f1_score(y_true, final_vote_pred, average='micro',zero_division=0)
                    f1_weighted = f1_score(y_true, final_weighted_pred, average='micro', zero_division=0)
                    ...
                    if f1_weighted > best_f1:
                        ...
                        SSL_macro_f1_scores.append(best_f1)
        ...
        optimization_results[class_label]["final_f1_score"] = best_f1
        ...
        print(f"SSL Optimal Threshold: {best_threshold:.2f} (F1-score: {best_f1:.4f})")
        ...
        if all(al_model in best_predictions[class_label] for al_model in al_models):
            ...
            for alpha in np.arange(0.05, 0.95, 0.05):
                ...
                for threshold in np.arange(0.05, 0.95, 0.025):
                    ...
                    AL_macro_f1_scores.append(best_al_f1)
...
save_path = './05_Experiment_3/processed_TinyImageNet_dataset.npz'
save_dir = './05_Experiment_3/TinyImageNet_training_sets'
stats_path = './05_Experiment_3/TinyImageNet_training_stats.json'
feature_dir = './05_Experiment_3/TinyImageNet_features'
bovw_features_path = './05_Experiment_3/TinyImageNet_features/bovw_features.npz'
lbp_features_path = './05_Experiment_3/TinyImageNet_features/lbp_features.npz'
hog_features_path = './05_Experiment_3/TinyImageNet_features/hog_features.npz'
AL_results_dir= './05_Experiment_3/TinyImageNet_training_sets_AL'
reshaped_dir = './05_Experiment_3/TinyImageNet_training_sets_AL_reshaped'
SSL_results_dir = './05_Experiment_3/TinyImageNet_training_sets_SSL'
output_stats_path = './05_Experiment_3/TinyImageNet_training_set_validation.json'
output_stats_path_AL = './05_Experiment_3/TinyImageNet_training_set_validation_AL.json'
output_stats_path_SSL = './05_Experiment_3/TinyImageNet_training_set_validation_SSL.json'
results_output_dir = os.path.join(SSL_results_dir, 'ssl_output')

coco_dataset = TinyImageNetDataset(images_dir, annotations_path)
...
training_set_dirs = [AL_results_dir, SSL_results_dir]
output_dirs = ["05_Experiment_3/TinyImageNet_results/AL","05_Experiment_3/TinyImageNet_results/SSL"]
