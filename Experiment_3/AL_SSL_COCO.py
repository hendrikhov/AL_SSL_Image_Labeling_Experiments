...
from sklearn.metrics import precision_score, recall_score, f1_score, precision_recall_curve, accuracy_score, log_loss, roc_auc_score, average_precision_score, roc_curve,confusion_matrix, hamming_loss
    ...
    for class_label in range(ground_truth_labels.shape[1]):
        ...
        if len(missing_image_ids) > 0:
            ...
            if method == "roc":
                ...
                if len(np.unique(aligned_labels)) < 2:  # Ensure at least one positive and one negative value
                    print(f"Skipping PRC calculation for Class {class_label} due to insufficient label diversity.")
...
save_path = './05_Experiment_3/processed_coco_dataset.npz'
save_dir = './05_Experiment_3/coco_training_sets'
stats_path = './05_Experiment_3/coco_training_stats.json'
feature_dir = './05_Experiment_3/coco_features'
bovw_features_path = './05_Experiment_3/coco_features/bovw_features.npz'
lbp_features_path = './05_Experiment_3/coco_features/lbp_features.npz'
hog_features_path = './05_Experiment_3/coco_features/hog_features.npz'
AL_results_dir= './05_Experiment_3/coco_training_sets_AL'
reshaped_dir = './05_Experiment_3/coco_training_sets_AL_reshaped'
SSL_results_dir = './05_Experiment_3/coco_training_sets_SSL'
...
if os.path.exists(output_stats_path_SSL):
    ...
    all_trained_models, performance_log, results_matrix, image_ids = main_ssl_pipeline(models, reshaped_dir, SSL_results_dir, reshaped_dataset, labels, iterations=80)
...
output_dirs = ["05_Experiment_3/coco_results/AL","05_Experiment_3/coco_results/SSL"]
