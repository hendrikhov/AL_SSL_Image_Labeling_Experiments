...
from sklearn.metrics import classification_report, confusion_matrix, hamming_loss, accuracy_score, jaccard_score, matthews_corrcoef
...
def log_experiment(labeled_samples, feature_name, model_name, strategy_name):
    ...
    try:
        ...
        # Append the new entry to the global DataFrame
...
augmented_dataset_path = "./PascalVOC_cache/augmented_dataset.pkl"
train_val_test_splits_path = "./PascalVOC_cache/train_val_test_splits.pkl"
features_cache_dir = "./PascalVOC_cache/features/"
label_cache_dir = "./cache_PascalVOC/labels/"
feature_cache_dir = "./cache_PascalVOC/features/"
split_cache_dir = "./cache_PascalVOC/splits"
...
if __name__ == "__main__":
    ...
    if os.path.exists(augmented_dataset_path):
        ...
        full_dataset = PascalVOCDataset(images_dir, annotations_path, transform=transform)
    ...
    for num_labeled in labeled_data_sizes:
        ...
        for epoch in range(max_epochs):
            ...
            val_loss = trainer.compute_validation_loss(val_loader)
        ...
        evaluate_resnet(
            ...
            results_csv_file="ssl_resnet_results_COCO.csv",
