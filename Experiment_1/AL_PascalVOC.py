...
from torch.utils.data import DataLoader, Dataset, Subset, WeightedRandomSampler, ConcatDataset, TensorDataset
...
full_dataset = PascalVOCDataset(img_dir=images_dir, annotation_path=annotations_path, transform=transform)
